...
## Tehtävä 1.4 - 2p (tein tämän kohdan ensimmäisenä!)
...
## Tehtävä 1.2 - 4p: Raspbianin määritys
...
3. Avasin Kitty-nimisen SSH-clientin. Enabloin Kittyn asetuksista X11:n. Yhdistin edellämainittuun IP:seen ja kirjauduin sisään oletustunnuksilla: `pi` ja `raspberry`.
...
8. Hoidin päivitykset:
    ...
    ```
    Poistin turhat paketit: `sudo apt-get autoremove`.
...
## Tehtävä 1.3 - 3p: Etäyhteys
(Tämä tehtävä tuli tehtyä tehtävien 1.4 ja 1.2 aikana, mutta tässä yhteenveto:)
